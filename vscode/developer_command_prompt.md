...
- you will get something like this in the editor:
```json
{
...
- then select profile "Developer Command Prompt" or whatever you named it
#### terminal context menu

Once you have a terminal running you can also start from terminal context menu.

![terminal context menu](dcp_from_terminal.png)
